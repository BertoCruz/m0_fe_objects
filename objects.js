...
var email = {
  ...
  to: "Alex",
  subject: "We got this!",
  body: "just want to say, you're the man ;)",
  send: true
};
console.log("---------------------------------------");
...
var emails = [
  ...
  },
  {
    ...
    body: "Yo, What's up Matt? how are the kids?",
    send: true
  },
  {
    sender: "Dani",
    to: "neighbor",
    subject: "CONTROL YOUR DOG!",
    body: "Steve, you need to do something about that dog of yours. He pooped on my porch again!",
    send: false
  }
];
